 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ir(e,t,n=!1){if((0,r.xZ)(e.app))return Promise.reject(m(e));const i=xe(e),s=qn(i,t),o=new Zn(i,s,n),a=await o.execute();return a&&!n&&(delete a.user._redirectEventId,await i._persistUserIfCurrent(a.user),await i._setRedirectUser(null,t)),a}
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.b6fa1d33.js.map