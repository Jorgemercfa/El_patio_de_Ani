 ...
 * limitations under the License.
 */
function Du(e){e=he(e,Tc);const t=he(e.firestore,Oc),n=Dc(t);return lc(n,e._key).then((n=>Fu(t,e,n)))}function xu(e){e=he(e,Ec);const t=he(e.firestore,Oc),n=Dc(t),r=new au(t);return du(e._query),hc(n,e._query).then((n=>new Ou(t,r,e,n)))}function Pu(e,t,n){e=he(e,Tc);const r=he(e.firestore,Oc),i=Cu(e.converter,t,n),s=Kc(r);return Vu(r,[Hc(s,"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,Mr.none())])}function Lu(e,t,n,...r){e=he(e,Tc);const i=he(e.firestore,Oc),s=Kc(i);let o;return o="string"==typeof(t=(0,a.Ku)(t))||t instanceof Lc?Qc(s,"updateDoc",e._key,t,n,r):Gc(s,"updateDoc",e._key,t),Vu(i,[o.toMutation(e._key,Mr.exists(!0))])}function Mu(e,t){const n=he(e.firestore,Oc),r=Cc(e),i=Cu(e.converter,t),s=Kc(e.firestore);return Vu(n,[Hc(s,"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,Mr.exists(!1))]).then((()=>r))}function Vu(e,t){const n=Dc(e);return dc(n,t)}function Fu(e,t,n){const r=n.docs.get(t._key),i=new au(e);return new ku(e,i,t._key,r,new Au(n.hasPendingWrites,n.fromCache),t.converter)}new WeakMap;
/**
 * @license
 * Copyright 2023 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.a4ebcf3d.js.map