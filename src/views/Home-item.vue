  ...
  <div class="home-area">
    ...
    <div class="main-video-carousel">
      ...
      <div class="main-video-wrapper" ref="mainWrapperRef">
        <!-- FIX: antes había dos <transition> separados (uno para índices
             pares y otro para impares) y AMBOS usaban ref="videoRef". Como
             durante el crossfade el video saliente y el entrante coexisten
             brevemente en el DOM, dos nodos distintos competían por el
             mismo nombre de ref, y Vue no garantiza cuál de los dos gana
             esa asignación. Eso hacía que el zoom se aplicara al video
             equivocado (o a uno ya desmontado) y que, mientras más avanzaba
             el carrusel, más se notara en los últimos videos del ciclo.
             Ahora hay un único bloque, y :key="currentVideoIndex" es lo que
             le dice a Vue que anime la salida/entrada en cada cambio de
             video (mismo efecto de crossfade), sin duplicar el ref. -->
